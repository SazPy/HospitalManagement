...
SECRET_KEY = 'django-insecure-)n(cz7^2=hmw8+1)+zgb(k#v8@x406$yx7zpk*w8%hxvw=z$+%'
...
AUTH_USER_MODEL = 'main_fns_app.User'
# Redirect to custom login URL
LOGIN_URL = 'login'  # This is the name you assigned to your login path
